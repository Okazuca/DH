export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	basculin: {
		...
		color: "Green",
		eggGroups: ["Water 2"],
		otherFormes: ["Basculin-Blue-Striped","Basculegion"],
		formeOrder: ["Basculin", "Basculin-Blue-Striped","Basculegion"],
	},
	basculinbluestriped: {
		num: 550,
